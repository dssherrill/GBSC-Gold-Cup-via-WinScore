...
def render_html(payload: dict[str, Any]) -> str:
    ...
    sections = [
        ...
        "<thead>",
        '<tr><th rowspan="2">Rank</th><th rowspan="2">Pilot</th><th rowspan="2">Score</th><th colspan="3">Best 3 Flights</th></tr>',
...
.gold-cup-table.standings thead tr:first-child th:last-child {
    text-align: center;
}

.gold-cup-table.standings thead tr:nth-child(2) th,
.gold-cup-table.standings tbody td:nth-child(4),
.gold-cup-table.standings tbody td:nth-child(5),
.gold-cup-table.standings tbody td:nth-child(6) {
    text-align: center;
}
